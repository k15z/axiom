...
The agent builds notes about your codebase across runs, stored in `.axiom/.cache/notes.json`. See [Agent Memory](./agent-memory.md) for how notes work, cost impact, and debugging.
